...
namespace Department.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DepartmentsId,DepartmentName")] Departments departments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DepartmentsId,DepartmentName")] Departments departments)
        {
            if (ModelState.IsValid)
            {
